...
from db.classes import WarehouseShippedItem
...
router = APIRouter()
svc = ApiService(db.warehouse_shipped_items_table, warehouse_shipped_item_schema)
table_class = WarehouseShippedItem
base_path = "/warehouse_shipped_items/"
