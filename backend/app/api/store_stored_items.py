...
from db.classes import StoreStoredItem
...
router = APIRouter()
svc = ApiService(db.store_stored_items_table, store_stored_item_schema)
table_class = StoreStoredItem
base_path = "/store_stored_items/"
